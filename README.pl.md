...
`MESSAGE_LANGUAGE` wybiera język wiadomości Telegram. Obsługiwane wartości to `pl`
i `en`. Nazwy wydarzeń gospodarczych pozostają w formie zwróconej przez FTMO.
